...
--enable-libdvdnav --enable-libdvdread --disable-xlib \
...
--enable-filter='pipe,gblur_vulkan,acopy,copy,anull,framestep,settb,anullsink,anullsrc,null,nullsink,nullsrc,buffersrc,format,buffer,buffersink,abuffer,abuffersink,hwdownload,hwmap,hwupload,adelay,aecho,afifo,amix,aresample,aformat,asetpts,asplit,colorspace,crystalizer,crop,drawtext,equalizer,firequalizer,scale_cuda,hwupload_cuda,bilateral_cuda,thumbnail_cuda,bwdif_cuda,chromakey_cuda,colorspace_cuda,overlay_cuda,pad_cuda,yadif_cuda,ladspa,libplacebo,loudnorm,lv2,nullsrc,overlay,palettegen,paletteuse,pan,rubberband,scale,scale_npp,setpts,transpose,volume' \
