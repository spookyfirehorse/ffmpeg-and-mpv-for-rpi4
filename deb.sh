...
sudo apt install -y xcb-xkb*-dev libxvidcore-dev libvpx-dev libssh-gcrypt-dev libmp3lame-dev  autoconf automake build-essential pkg-config devscripts cmake  imagemagick libasound2-dev libass-dev libfreetype6-dev \
