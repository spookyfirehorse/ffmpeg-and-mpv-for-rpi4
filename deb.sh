...
sudo apt install -y xcb-xkb*-dev libmp3lame-dev  autoconf automake build-essential pkg-config devscripts cmake  imagemagick libasound2-dev libass-dev libfreetype6-dev \
