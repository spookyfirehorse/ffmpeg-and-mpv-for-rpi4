sudo apt purge vlc-bin vlc vlc-data && \
sudo apt install -y autoconf automake build-essential pkg-config devscripts cmake doxygen git graphviz imagemagick libasound2-dev libass-dev libfreetype6-dev \
