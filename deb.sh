...
sudo apt install -y xcb-xkb*-dev  libdrm-dev libxvidcore-dev libvpx-dev libssh-gcrypt-dev libmp3lame-dev  autoconf automake build-essential pkg-config devscripts cmake  imagemagick libasound2-dev libass-dev libfreetype6-dev \
libgmp-dev  libopus-dev librtmp-dev libsdl2-dev libsdl2-image-dev libsdl2-mixer-dev libsdl2-net-dev libsdl2-ttf-dev \
libsnappy-dev libsoxr-dev libssl-dev  libv4l-dev libva-dev  doxygen git graphvizlibvorbis-dev libx264-dev libxcb-shape0-dev \
...
libopencore-amrnb-dev libopencore-amrwb-dev libtheora-dev libvorbis-dev libxvidcore-dev x264 v4l-utils mousepad git-core libass-dev \
libfreetype6-dev libsdl2-dev libtool libvdpau-dev  libxcb1-dev libvpx-dev libpulse-dev  libwebp-dev libxvidcore-dev \
...
vlc-plugin-video-output libvlc5 libvlccore9 qml-module-qtquick-layouts libqt5quick* qtquickcontrols2-5-dev  && \
