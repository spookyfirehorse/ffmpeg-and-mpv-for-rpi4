...
./configure --prefix=/usr \
 ...
 --enable-ffmpeg --enable-ffprobe --enable-ffplay --enable-shared --disable-static --disable-debug --enable-stripping --enable-hardcoded-tables --enable-pic --enable-pthreads --enable-gpl --enable-version3 --enable-nonfree --enable-lto --enable-avcodec --enable-avformat --enable-avfilter --enable-swresample --enable-swscale --enable-avdevice \
 ...
 --disable-cuda --enable-nvenc --enable-cuda-llvm --enable-nvdec --enable-cuvid  --enable-libnpp --enable-ffnvcodec --enable-cuda-nvcc --enable-libnpp --enable-ffnvcodec --disable-libx264 --disable-libx265 --disable-omx --disable-omx-rpi --disable-mmal --disable-amf --disable-vdpau --disable-vaapi \
