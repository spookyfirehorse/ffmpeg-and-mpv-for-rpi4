...
./configure \
  ...
  --extra-cflags='-I/usr/include/libdrm -I/usr/include/gbm -I/usr/include/vulkan -mcpu=cortex-a72 -Ofast -fomit-frame-pointer -falign-functions=32 -falign-loops=32 -mlow-precision-div -pipe -ftree-vectorize -fno-semantic-interposition -Wno-stringop-overflow' \
  ...
  --enable-hwaccel=hevc_v4l2request --enable-hwcontext \
