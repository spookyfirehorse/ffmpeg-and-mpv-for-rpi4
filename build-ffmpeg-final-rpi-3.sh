...
./configure \
 ...
 --extra-libs='-lgbm -ldrm -lepoxy -lEGL -lGLESv2 -lfftw3 -lgnutls -lxml2 -lmp3lame -lFLAC -lopus -lass -lsoxr -lz -lsrt -ldvdnav -lstdc++ -lpthread -lm -lrt -ldl' \
--disable-everything --disable-hwaccels --enable-libdvdnav --enable-libdvdread \
 ...
 --disable-indev=pulse,oss --disable-outdev=pulse,oss --disable-avx --disable-avx2 --disable-avx512 --disable-fma3 --disable-fma4 --disable-xop
