...
--disable-everything --disable-hwaccels --enable-libdvdnav --enable-libdvdread \
 ...
 --enable-parser='png,dvd_nav,webp,vp8,vp9,vc1,aac_latm,aac,ac3,eac3,dca,mpegaudio,mp3,vorbis,opus,flac,h264,hevc,mpegvideo,mpeg4video,mjpeg,h263,mpeg1video,av1' \
