...
./configure --prefix=/usr \
 ...
 --enable-protocol='pipe,file,fd,tcp,udp,rtp,rtsp,http,https,tls,rtmp,rtmpt,rtmpe,rtmps,librtmpe,librtmps,librtmpt,ffrtmpcrypt,hls,dash,libsrt,unix,cache,crypto,concat'
