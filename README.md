...
in the original config from raspberrypi ffmpeg apt install neon enabled with is not correct also thumb is not supported 


rpi zero w  --cpu=arm1176jzf-s --arch=arm --enable-armv6t2 --disable-armv6 --disable-armv5te --enable-vfp --disable-thumb
