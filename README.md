...
do not use in this case hwdec=v4l2m2m-copy  or drm-copy , maybe only drm but hwdec=auto is  the best, drm-copy works also but not with hwdec-image-format=drm_prime  which is very stable for all formats
