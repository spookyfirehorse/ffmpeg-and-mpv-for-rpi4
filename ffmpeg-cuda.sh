...
./configure --prefix=/usr/local --enable-gpl --enable-nonfree --extra-version=4 --toolchain=hardened --enable-libvpx  \
...
--enable-libsnappy --enable-shared --enable-libnpp --extra-cflags=-I/usr/local/cuda/include/ --extra-ldflags=-L/usr/local/cuda/lib64/  \
