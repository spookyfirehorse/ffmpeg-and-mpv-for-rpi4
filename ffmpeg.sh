...
--enable-gnutls --enable-ladspa --enable-libaom --enable-libass --enable-libbluray --enable-libbs2b --enable-libcaca --enable-libcdio --enable-libcodec2 --enable-libflite \
 ...
 --enable-chromaprint --enable-frei0r --enable-libx264 --enable-avisynth --extra-version=2 --enable-static --incdir=~/ffmpeg_build/include/arm-linux-gnueabihf  --libdir=~/ffmpeg_build/lib/arm-linux-gnueabihf --cpu=arm1176jzf-s --arch=arm   && \
