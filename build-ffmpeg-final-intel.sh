...
--enable-decoder='jpeg2000,apng,wavpack,tta,ape,mjpegb,jpegls,mjpeg,png,prores,prores_raw,wrapped_avframe,libx264,mjpeg_vaapi,h264,hevc,h264_vulkan,hevc_vulkan,vp9,av1,mpeg1video,mpeg2video,mpeg4,aac,mp3,flac,vorbis,opus,pcm_s16le,pcm_s16be,pcm_s24le,pcm_s24be,pcm_s32le,pcm_s32be,pcm_f32le,pcm_f32be,pcm_s64le,pcm_s64be,pcm_f64le,pcm_f64be,pcm_u8,pcm_alaw,pcm_mulaw,rawvideo,adpcm_ms,adpcm_ima_wav,adpcm_ima_qt,adpcm_swf,ass,srt,dvdsub,dvbsub' \
